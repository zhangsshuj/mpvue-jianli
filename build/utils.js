...
exports.cssLoaders = function (options) {
  ...
  const sassResourcesLoader = {
    ...
    options: {
      resources: path.resolve(__dirname, '../src/assets/style/px2rem.scss')  //注意自己的路径
    }
  }
  ...
  return {
    ...
    sass: generateLoaders('sass', { indentedSyntax: true }, sassResourcesLoader),
    scss: generateLoaders('sass', sassResourcesLoader),
